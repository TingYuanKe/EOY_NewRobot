...
void DrawLimb(nite::UserTracker* pUserTracker, const nite::SkeletonJoint& joint1, const nite::SkeletonJoint& joint2, int color)
{
	...
	glPointSize(20.0f); //glPointSize(2);
	glVertexPointer(3, GL_FLOAT, 0, coordinates);
...
void SampleViewer::Display()
{
	...
	if (depthFrame.isValid() && g_drawDepth)
	{
		//const cv::Mat mImageDepth(depthFrame.getHeight(), depthFrame.getWidth(), CV_8UC3, (void*)depthFrame.getData());
		//imwrite("./images/RobotDepthImage.jpg", mImageDepth);
